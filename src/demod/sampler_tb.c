...
int main(int argc, char *argv[]){
    ...
    //int complex  outputSignal[] = {[0 ... length-1] = 0};
    int demodSignal[] = {[0 ... smplPerSymb-1] = 0};
    int complex  outputSignal = 0;
