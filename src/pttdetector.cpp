...
class PttDetector
{
    ...
    //Properties constants
        ...
        const int   worstCNO      = 40;     // Minimum detectable Carry to N0 
                                            // dB ratio (aprox 12.7 Eb/N0)  
        ...
        int  bw0;          // Signal bandwidth in multiple of
                                        // sampleRate/dftLength
...
PttDetector::PttDetector(SimParam param)
{
