...
PULP_APP_HOST_SRCS = src/main_receiver.c src/decoder.c src/detect_loop.c src/service.c src/demod/cicFilterCplxStep.c src/demod/pttA2Demod.c src/demod/sampler.c 
